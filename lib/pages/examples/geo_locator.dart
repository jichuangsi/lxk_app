...
import 'geo_locator/lookup_address_widget.dart';
import 'geo_locator/calculate_distance_widget.dart';
import 'geo_locator/current_location_widget.dart';
import 'geo_locator/location_stream_widget.dart';
...
class GeolocatorPage extends StatefulWidget {
  @override
  State<GeolocatorPage> createState() => BottomNavigationState();
}

class BottomNavigationState extends State<GeolocatorPage> {
